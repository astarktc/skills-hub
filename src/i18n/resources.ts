export const resources = {
  en: {
    translation: {
      ...
      invocationEdit: {
        title: "Invocation mode — {{name}}",
        choose: "Who can invoke this skill?",
        follow: "Follow the skill's own setting (currently: {{mode}})",
        note: "Only Claude Code honours these keys today; other tools ignore them.",
        overridden: "Overridden",
        overrideTooltip: "Overridden; the skill itself says {{mode}}",
        conflictTooltip: "Overridden; upstream changed its setting to {{mode}}",
        conflictBanner: "The skill's upstream changed its own setting to {{mode}} after you overrode it. Keeping your override re-bases it; 'Follow the skill's own setting' clears it.",
        save: "Save",
      ...
      viewMode: "View",
      viewList: "List",
      viewAutoGrid: "Auto Grid",
      viewDenseGrid: "Dense Grid",
      ...
      notifications: {
        ...
        emptyHint:
          "Outcomes of this session's actions — installs, syncs, failures — are listed here.",
        copyEntry: "Copy this notification",
        copyAll: "Copy all",
        clear: "Clear",
        kind: {
          error: "Error",
      ...
      errors: {
        ...
        noSkillsFoundLocal:
          "No skills found in this folder (SKILL.md not detected).",
        skillAlreadyExists:
          'Skill "{{name}}" already exists. Please rename it.',
      ...
      projects: {
        ...
        emptyBody:
          "Register a project directory to start assigning skills. Each project gets its own set of AI tool skills via symlinks.",
        ...
        allTools: "All Tools",
        allToolsTitle: "Assign {{name}} to every configured tool",
        unassignAll: "Unassign All",
        unassignAllTitle: "Remove {{name}} from every tool in this project",
        assignmentCount: "{{count}} assigned",
        toolCount: "{{count}} tools",
        skillCount: "{{count}} skills",
        projectMeta: "{{tools}} tools, {{skills}} skills",
        ...
        noSkills:
          "No skills installed. Add skills from the My Skills tab first.",
        ...
        bulkAssignSuccess_one: "Assigned to {{count}} tool",
        bulkAssignSuccess_other: "Assigned to {{count}} tools",
        bulkAssignNothing: "Already assigned to every configured tool",
        bulkUnassignSuccess_one: "Removed from {{count}} tool",
        bulkUnassignSuccess_other: "Removed from {{count}} tools",
        bulkUnassignPartial:
          "Removed {{count}} assignments; {{failed}} could not be removed and are marked in error",
        syncDisabledMissing:
  ...
  zh: {
    translation: {
      ...
      invocationEdit: {
        title: "调用模式 — {{name}}",
        choose: "谁可以调用该 Skill？",
        follow: "遵循 Skill 自身的设置（当前：{{mode}}）",
        note: "目前只有 Claude Code 支持这些字段，其他工具会忽略它们。",
        overridden: "已覆盖",
        overrideTooltip: "已覆盖；Skill 自身的设置为{{mode}}",
        conflictTooltip: "已覆盖；上游已将设置改为{{mode}}",
        conflictBanner: "你覆盖设置后，Skill 的上游将自身设置改为{{mode}}。保留覆盖会以新设置为基准；选择“遵循 Skill 自身的设置”可清除覆盖。",
        save: "保存",
        saved: "调用设置已保存",
      ...
      gitCacheCleanupHint:
        "启动时清理超过 N 天未使用的 Git 缓存，设为 0 表示不清理。",
      ...
      notifications: {
        ...
        empty: "暂无通知",
        emptyHint: "本次会话中操作的结果（安装、同步、失败）会显示在这里。",
        copyEntry: "复制此条通知",
        copyAll: "全部复制",
        clear: "清空",
        kind: {
      ...
      errors: {
        ...
        noSyncTargets:
          "未选择任何同步目标工具，请在“创建 Skills -> 同步目标”里勾选。",
        noSkillsFoundWithHint:
          "未在该仓库中发现可导入的 Skills（未找到 SKILL.md）。",
        noSkillsFoundLocal:
          "未在该目录中发现可导入的 Skills（未找到 SKILL.md）。",
        skillAlreadyExists: "技能「{{name}}」已存在，请更换名称后再安装。",
        duplicateSelectedSkills:
          "所选 Skills 含有重复名称「{{name}}」，请只选择一个。",
      ...
      projects: {
        ...
        emptyTitle: "尚未注册任何项目",
        emptyBody:
          "注册一个项目目录即可开始分配 Skills。每个项目通过符号链接拥有自己的一套 AI 工具 Skills。",
        emptyAction: "添加项目",
        selectProject: "选择一个项目以管理 Skill 分配",
        syncProject: "同步项目",
        syncAll: "全部同步",
        addTools: "配置工具",
        allTools: "全部工具",
        allToolsTitle: "将 {{name}} 分配到所有已配置的工具",
        unassignAll: "全部取消",
        unassignAllTitle: "从本项目的所有工具中移除 {{name}}",
        assignmentCount: "已分配 {{count}} 个",
        toolCount: "{{count}} 个工具",
        skillCount: "{{count}} 个 Skills",
        projectMeta: "{{tools}} 个工具，{{skills}} 个 Skills",
        configureProject: "配置项目",
        save: "保存",
        addProjectTitle: "注册项目",
        pathLabel: "项目目录",
        browse: "浏览文件夹",
        pathHelper: "选择项目的根目录",
        register: "注册项目",
        ...
        toolConfigConfirm: "保存工具",
        removeTitle: "移除项目",
        removeBody:
          "确定从 Skills Hub 移除「{{name}}」吗？这将删除该项目工具目录下所有已同步的 Skill 符号链接和副本。",
        ...
        lastSyncNever: "从未同步",
        assignmentExistsError: "该 Skill 已分配给该工具",
        notFoundError: "未找到对象",
        pathMissing: "（不存在）",
        pathMissingWarning: "未找到项目目录，同步操作已禁用。",
        updatePath: "更新路径",
        updatePathSuccess: "项目路径已更新",
        bulkAssignPartial: "已分配 {{assigned}} 个，{{failed}} 个失败",
        bulkAssignSuccess_one: "已分配到 {{count}} 个工具",
        bulkAssignSuccess_other: "已分配到 {{count}} 个工具",
        bulkAssignNothing: "已分配到所有已配置的工具",
        bulkUnassignSuccess_one: "已从 {{count}} 个工具中移除",
        bulkUnassignSuccess_other: "已从 {{count}} 个工具中移除",
        bulkUnassignPartial: "已移除 {{count}} 个分配；{{failed}} 个无法移除，已标记为错误",
