...
Status: superseded — round4/issues/01-typed-missing-path-errors
...
- 2026-09-15 — Status reconciliation: needs-triage → superseded — round4/issues/01-typed-missing-path-errors. Evidence: Round4 spec ticket map routes this aggregate to terminal round4/issues/01-typed-missing-path-errors (primary pointer), 02-acquisition-follows-upstream-symlinks, 03-propagation-project-sync-dedupe-overlap-test, 04-reporter-world-nits and 09-unlocatable-skill. All target files exist and are terminal; the formatError direction was subsequently superseded by round5/spec.md Q1.
